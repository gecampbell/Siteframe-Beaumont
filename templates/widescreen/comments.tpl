...
<div class="comment_subject" style="padding-left:{$comments[i].clevel*12}px;">
    ...
    <a href="{$comments[i].user.url}"><img src="{thumbnail file=$comments[i].user.user_photo type=$comments[i].user.user_photo_type size=60}" alt="" style="float:left;" class="cimage" /></a>
    {/if}
...
{if $cuser.user_id && $allow_comments}
    ...
    {literal}
    <script type="text/javascript">hide('cform');</script>
    {/literal}
{/if}
