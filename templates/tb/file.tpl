{* $Id: file.tpl,v 1.6 2005/12/12 22:14:21 glen Exp $
...
<a href="javascript:popup('{$site_path}/file.php?id={$file_id}&amp;template=imagepopup','image','height={$image_y},width={$image_x}');"  title="Click to view full-sized" ><img src="{thumbnail file=$file_path type=$file_type maxw=600}" alt="{$file_name}" height="{$im_h}" width="{$im_w}" /></a>
{else}
