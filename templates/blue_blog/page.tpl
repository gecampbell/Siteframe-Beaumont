...
<a href="{$comments[i].edit_url}">Edit</a> &rsaquo;
<a href="{$comments[i].delete_url}&amp;r={$url|escape:"url"}">Delete</a> &rsaquo;
{/if}
{if $cuser.user_id}
...
&rsaquo; {$comments[i].comment_created|ydate:"at $time_format on $date_format"}</p>
