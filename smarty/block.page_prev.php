<?php
// $Id: block.page_prev.php,v 1.2 2005/12/24 22:56:28 glen Exp $
// Copyright (c)2005, Glen Campbell. All rights reserved.
//
// fetches the next page in the folder represented by the 
// specified page and folder IDs
// EXAMPLE:
// {page_prev page=12 folder=32} ... {/page_prev}

// smarty_block_page_prev()
// this is the function that implements the block
function smarty_block_page_prev($parm, $content, &$smarty, &$repeat)
{
    static $myquery;
